    ...
    <div className="db2-container">
      ...
      <aside className="db2-sidebar">
        ...
        <div className="db2-new-btn-wrapper">
          <button className="db2-btn-primary">
        ...
        <div className="db2-bottom-nav">
          <div className="db2-user-profile">
            ...
            <button className="db2-user-icon-btn" onClick={toggleTheme} title="Cambiar tema">
              {theme === 'light' ? <Moon size={18} /> : <Sun size={18} />}
            </button>
            <button className="db2-user-icon-btn" title="Notificaciones">
              <Bell size={18} />
            </button>
          </div>
